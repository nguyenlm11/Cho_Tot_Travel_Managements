...
import { FaTimes, FaBed, FaBath, FaWifi, FaChild, FaUser, FaUsers, FaArrowLeft, FaCloudUploadAlt, FaTrash, FaCheck, FaPlus, FaHome, FaUtensils } from 'react-icons/fa';
                        ...
                        <div className="space-y-6">
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                                ...
                                                <div className="group">
                                                    ...
                                                    <div className="flex space-x-4">
                                                        <div className="flex items-center">
                                                            ...
                                                            />
                                                            <label htmlFor="rentWhole" className="ml-2 text-gray-700 dark:text-gray-300">
                                                                Thuê nguyên căn
                                                            </label>
                                                        </div>
                                                        <div className="flex items-center">
                                                            <input
                                                                ...
                                                                className="w-4 h-4 text-primary"
                                                            />
                                                            <label htmlFor="rentRoom" className="ml-2 text-gray-700 dark:text-gray-300">
                                                                Thuê từng phòng
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                {/* Room Facilities */}
                                                <div className="space-y-6">
                                                    <h3 className="text-lg font-medium text-gray-800 dark:text-white">Tiện nghi riêng của căn</h3>
                                    ...
                                    />
                                                            {errors.numberKitchen && (
                                                                <p className="text-red-500 text-sm mt-1">{errors.numberKitchen}</p>
                                                            )}
                                </div>

                                                        <div className="group">
                                                            <label className="text-base font-medium text-gray-700 dark:text-gray-300 mb-2 block flex items-center">
                                                                <FaWifi className="mr-2 text-primary" />
