...
import { FaSearch, FaBed, FaUsers, FaEdit, FaTrash, FaEye, FaPlus, FaFilter, FaCheckCircle, FaTimesCircle, FaChevronLeft, FaChevronRight, FaCheck, FaTimes } from 'react-icons/fa';
...
const RoomTypeList = () => {
    ...
    const statsData = [
        ...
        },
        {
            ...
            value: roomTypes.filter(rt => rt.status === 'active').length,
            color: 'from-green-500 to-green-600',
            icon: <FaCheck className="w-6 h-6" />
        },
        {
            label: 'Không hoạt động',
            value: roomTypes.filter(rt => rt.status === 'inactive').length,
